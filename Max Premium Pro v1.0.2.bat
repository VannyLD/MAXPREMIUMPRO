...
powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://github.com/VannyLD/MAXPREMIUMPRO/releases/download/%NEW_VERSION%/Max.Premium.Pro.exe', 'Max Premium Pro.exe')"
